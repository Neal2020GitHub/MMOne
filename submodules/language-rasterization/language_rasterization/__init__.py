...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, language_feature, radii, alpha, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, language_feature, radii, alpha

    @staticmethod
    def backward(ctx, grad_out_color, grad_out_language_feature, _, grad_out_alpha):
